...
`\lettrine[lines=3]{L}{os}`{=latex} Capítulos 2 y 3 produjeron **estimaciones puntuales** $\hat{\beta}_j$ a partir de una muestra. Estos números son aleatorios: una muestra distinta habría dado números distintos. La cuestión de la inferencia es si lo que aprendimos de *nuestra* muestra nos permite decir algo creíble sobre el parámetro poblacional desconocido $\beta_j$.
