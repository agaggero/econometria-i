...
`\lettrine[lines=3]{E}{n}`{=latex} el Capítulo 4 enumeramos los supuestos RLM.1--RLM.6 del modelo de regresión lineal múltiple que justifican MCO. El supuesto de **homocedasticidad** RLM.5 establece que la varianza del error es la misma para cualquier valor de los regresores:
...
### Detección informal: gráficos de residuos
...
## Práctica: Heterocedasticidad en R
