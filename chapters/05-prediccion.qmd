...
## Varianza de la predicción e intervalos de predicción
...
### Intervalo de confianza para la media condicional $\mathbb{E}[y \mid x_0]$
...
### Intervalo de predicción para un valor individual $y_0$
...
## Selección de modelos: $R^2$, $R^2$ ajustado, AIC, BIC
...
### $R^2$ y el problema de las variables «basura»
...
## Práctica: Predicción y Selección de Modelos en R
